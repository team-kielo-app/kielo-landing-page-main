    ...
    >
      ...
      <img
        ...
        onError={(e) => {
          ...
          target.onerror = null;
          target.src =
            "https://placehold.co/400x450/989bdb/ffffff?text=Image+Error";
        }}
      />
...
export function LandingAccordionItem() {
  ...
  return (
    <div
      ref={sectionRef}
      className="bg-[#fcfaf2] font-sans flex justify-center"
      ...
      <section className="w-full max-w-[1280px] px-4 md:px-8 py-16 md:py-24">
        <div className="flex flex-col md:flex-row-reverse items-center justify-between gap-8 md:gap-12">
          ...
          <div className="w-full md:w-1/2">
            <div className="flex flex-row items-center justify-center gap-4 overflow-x-auto py-4">
