...
export const metadata: Metadata = {
  ...
  description:
    "Read Kielo's privacy policy to understand how we collect, use, and protect your personal data.",
};
          ...
          <div className={styles.content}>
            ...
            <div className={styles.placeholderBox}>
              ...
              <p className={styles.note}>
                Include data collection practices, GDPR compliance, user rights,
